	...
	lua.new_enum<item_misc_id>("ItemMiscID",
	    {
	        ...
	        { "Amulet", IMISC_AMULET },
	        { "Unique", IMISC_UNIQUE },
	        { "OilFirst", IMISC_OILFIRST },
	        { "OilOf", IMISC_OILOF },
	        { "OilAcc", IMISC_OILACC },
	        { "OilMast", IMISC_OILMAST },
	        { "OilSharp", IMISC_OILSHARP },
	        { "OilDeath", IMISC_OILDEATH },
	        { "OilSkill", IMISC_OILSKILL },
	        { "OilBSmth", IMISC_OILBSMTH },
	        { "OilFort", IMISC_OILFORT },
	        { "OilPerm", IMISC_OILPERM },
	        { "OilHard", IMISC_OILHARD },
	        { "OilImp", IMISC_OILIMP },
	        { "OilLast", IMISC_OILLAST },
	        { "GemDef", IMISC_GEMDEF },
	        { "MapOfDoom", IMISC_MAPOFDOOM },
	        { "Ear", IMISC_EAR },
	        { "SpecElixir", IMISC_SPECELIX },
	        { "RuneFirst", IMISC_RUNEFIRST },
	        { "RuneF", IMISC_RUNEF },
	        { "RuneL", IMISC_RUNEL },
	        { "GRRuneL", IMISC_GR_RUNEL },
	        { "GRRuneF", IMISC_GR_RUNEF },
	        { "RuneS", IMISC_RUNES },
	        { "RuneLast", IMISC_RUNELAST },
	        { "Auric", IMISC_AURIC },
	        { "Note", IMISC_NOTE },
	        { "ArenaPot", IMISC_ARENAPOT },
	    });
}
